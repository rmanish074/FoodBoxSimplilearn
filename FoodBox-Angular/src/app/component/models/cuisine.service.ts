...
export class CuisineService {
    ...
    // //     this._httpClient.get<Cuisine[]>("http://localhost:4200/cuisines").subscribe((result) => {
    // //   this.cuisineList = result;
    // //   console.log(this.cuisineList);
    // // }, (errors) => { console.log(errors); })
    //     // this._httpClient.get("http://localhost:4200/cuisines");
    // }
    ...
    getAllCuisines(): Observable<any> {
        ...
        // return this._httpClient.get<Cuisine[]>("http://localhost:4200/cuisines");
        let url = "http://localhost:9595/product";//this.baseUrl + "getAdminData/" + adminId;
    ...
    // //  return this.http.get(url , options);
    //  //return this._httpClient.get<Cuisine[]>("http://localhost:9595/products");

    //  return this._httpClient.get<Cuisine[]>("http://localhost:9595/product", 
    //  {headers : headers });
    ...
    getCuisineById(id: number) : Observable<Cuisine> {
        return this._httpClient.get<Cuisine>("http://localhost:9595/product/" + id);
    }
    ...
    //    let token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJqYXZhaW51c2UiLCJleHAiOjE2MjE5NzQ1NjEsImlhdCI6MTYyMTk1NjU2MX0.FXRVeXEjJF7ReeGYcKlQvP_U_8hCwyviL_VryIQdWGRHVJi1-o3_cPSILqMV-f2xQ2ZiFr2UsPJqUrSQO75e8g";//localStorage.getItem('token');
       ...
       return this.http.post(url , cuisine, options);
        ...
        // return this.http.post("http://localhost:9595/product", cuisine);
    }

    deletProductById(id : number) : Observable<any>
    {
        //let url = this.baseUrl + "saveAdmin";
        return this._httpClient.delete("http://localhost:9595/product/" + id);
